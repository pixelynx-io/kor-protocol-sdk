export const royaltyDistributionModuleAbi = [
  ...
  { inputs: [], name: 'FailedToActivateRoyalty', type: 'error' },
  { inputs: [], name: 'InvalidAddress', type: 'error' },
  { inputs: [], name: 'InvalidInitialization', type: 'error' },
  { inputs: [], name: 'InvalidRoyaltyStack', type: 'error' },
  { inputs: [], name: 'InvalidSignature', type: 'error' },
  { inputs: [], name: 'NotAnOwnerOfIP', type: 'error' },
  { inputs: [], name: 'NotInitializing', type: 'error' },
  { inputs: [], name: 'NotSourceIP', type: 'error' },
  { inputs: [], name: 'ReentrancyGuardReentrantCall', type: 'error' },
  { inputs: [], name: 'RoyaltyNotActive', type: 'error' },
  { inputs: [], name: 'RoyaltyVaultNotFound', type: 'error' },
  { inputs: [], name: 'SignatureExpired', type: 'error' },
  { inputs: [], name: 'SourceIPNotFound', type: 'error' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'revenueTokenAddress', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
